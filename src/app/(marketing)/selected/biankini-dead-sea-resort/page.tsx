...
export const metadata = {
  title: 'מתחם נופש יוקרתי ים המלח - 110 יחידות על 200 דונם | MULTIBRAWN',
  ...
  keywords: 'מתחם ים המלח, כפר נופש ים המלח, מתחם אירועים ים המלח, חתונות ים המלח, אירועי חברה, עיצוב מרוקאי, חוף פרטי, בוץ ים המלח, קליה',
  openGraph: {
    title: 'מתחם נופש יוקרתי ים המלח',
